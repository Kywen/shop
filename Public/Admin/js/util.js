    ...
    switch (msg.type) {
        ...
        case 'custom':
            ...
            if(content.type===1){
                ...
                str = '<img class="chartlet" onload="loadImg()" src="http://139.199.198.151:8000/shop_img/images/'+catalog+'/' +chartlet+'.png">';
            }else if(content.type==4){
...
function getAvatar(url){
    ...
    if(re.test(url)){
        ...
        return "http://139.199.198.151:8000/shop_img/images/default-icon.png"
    }
}   
